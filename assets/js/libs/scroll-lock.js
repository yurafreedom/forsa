! function (e, t) {
    ...
    var l = !1;
    var paddingRightItems = '.page-header';
    ...
    var d = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform)
        ...
        , o = function () {
            setTimeout(function () {
                void 0 !== v && (document.body.style.paddingRight = v, $(paddingRightItems).css('padding-right', v), v = void 0), void 0 !== s && (document.body.style.overflow = s, s = void 0)
            })
        };
        ...
        if (d) {
            ...
            n = e, setTimeout(function () {
                if (void 0 === v) {
                    ...
                    e && 0 < t && (v = document.body.style.paddingRight, document.body.style.paddingRight = t + "px", $(paddingRightItems).css('padding-right', t + "px"))
                }
